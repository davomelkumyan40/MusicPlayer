...
using EConTech.Windows.MUSICUI.Designer;

namespace EConTech.Windows.MUSICUI
{
	...
	/// <summary>
	///	  <para>
	///		MTrackBar represents an advanced track bar that is very better than the 
	///		standard trackbar.
	///   </para>
	///   <para>
	///   MTrackBar supports the following features:
	///   <list type="bullet">
	///     <item><c>M style, Office2003 style, IDE2003 style and Plain style.</c></item>
	...
	///     <item><c>You can change <see cref="MusicTrackBar.TickColor"/>, <see cref="MusicTrackBar.TickFrequency"/>, <see cref="MusicTrackBar.TickHeight"/>.</c></item> 
	///     <item><c>You can change <see cref="MusicTrackBar.TrackerColor"/> and <see cref="MusicTrackBar.TrackerSize"/>.</c></item> 
	///     <item><c>You can change <see cref="MusicTrackBar.TrackLineColor"/> and <see cref="MusicTrackBar.TrackLineHeight"/>.</c></item> 	
	...
	///   </para>
	/// </summary>
	[Description("MTrackBar represents an advanced track bar that is very better than the standard trackbar.")]
	[ToolboxBitmap(typeof(MusicTrackBar),"Editors.MTrackBar.MTrackBar.bmp")]
	[Designer(typeof(MTrackBarDesigner))]
	[DefaultProperty("Maximum")]
	[DefaultEvent("ValueChanged")]	
	public class MusicTrackBar : System.Windows.Forms.Control
	{	
		...
		private MBorderStyle _borderStyle = MBorderStyle.None;
		...
		/// <summary>
		/// Constructor method of <see cref="MusicTrackBar"/> class
		/// </summary>
		public MusicTrackBar()
		{
			...
			_borderStyle = MBorderStyle.None;
        ...
        [Description("Gets or sets the color of the controls circle.")]
        [Category("Layout")]
		...
		/// </summary>
		/// <remarks>
		/// For a <see cref="MusicTrackBar"/> with a large range of values between the <see cref="Minimum"/> and the 
		...
		[Description( "The current value for the MTrackBar, in the range specified by the Minimum and Maximum properties." )]
		[Category( "Behavior")]
		public int Value
		{
			get
		...
		/// <summary>
		/// Gets or sets the lower limit of the range this <see cref="MusicTrackBar"/> is working with.
		/// </summary>
		...
		/// <value>The minimum value for the <see cref="MusicTrackBar"/>. The default value is 0.</value>
		[Description("The lower bound of the range this MTrackBar is working with.")]
		[Category( "Behavior")]
		public int Minimum
		{
			get
		...
		/// <summary>
		/// Gets or sets the upper limit of the range this <see cref="MusicTrackBar"/> is working with.
		/// </summary>
		/// <remarks>You can use the <see cref="SetRange"/> method to set both the <see cref="Maximum"/> and <see cref="Minimum"/> properties at the same time.</remarks>
		/// <value>The maximum value for the <see cref="MusicTrackBar"/>. The default value is 10.</value>
		[Description("The uppper bound of the range this MTrackBar is working with.")]
		[Category( "Behavior")]
		public int Maximum
		{
			get
		...
		/// </summary>
		/// <value>A <see cref="MBorderStyle"/> that represents the border type of the trackbar control. 
		/// The default is <b>MBorderStyle.None</b>.</value>
		[Description("Gets or sets the border type of the trackbar control.")]
		[Category("Appearance"), DefaultValue(typeof(MBorderStyle), "None")]
		[DesignerSerializationVisibility(DesignerSerializationVisibility.Visible)]
		public MBorderStyle BorderStyle 
		{
			get 
			{
				return _borderStyle;
		...
		{
			DrawMStyleHelper.DrawAquaPillSingleLayer(g, drawRect,_trackLineColor,_orientation);
		}
		...
		{
			DrawMStyleHelper.DrawAquaPill(g, trackerRect,_trackerColor,_orientation, BaseColor);
		}
