...
namespace EConTech.Windows.MUSICUI.Designer
{
	/// <summary>
	/// The Designer for the <see cref="MusicTrackBar"/>.
	/// </summary>
	public class MTrackBarDesigner : System.Windows.Forms.Design.ControlDesigner
	{
		...
		{ 
			...
			get 
			{ 
				MusicTrackBar control = this.Control as MusicTrackBar;
		...
		/// not supported by the <see cref="MusicTrackBar"/>.
		/// </summary>
